...
const I18N = {
  pl: {
    ...
    "The Trend column shows each vessel's speed history as a sparkline; a larger chart appears in Behavioral Insights.": "Kolumna „Trend” pokazuje historię prędkości jednostki jako wykres; większy wykres znajdziesz w „Analizie zachowania”.",
    "Compare two vessels side by side with the Compare button in the Fleet Board — pick any two rows.": "Porównaj dwie jednostki obok siebie przyciskiem „Porównaj” w tabeli floty — wybierz dowolne dwa wiersze.",
  ...
  it: {
    ...
    "The Trend column shows each vessel's speed history as a sparkline; a larger chart appears in Behavioral Insights.": "La colonna „Andamento” mostra la cronologia della velocità di ogni nave; un grafico più grande è in „Analisi comportamentale”.",
    "Compare two vessels side by side with the Compare button in the Fleet Board — pick any two rows.": "Confronta due navi affiancate con il pulsante „Confronta” nella tabella flotta — scegli due righe qualsiasi.",
...
const HELP = [
  ...
  },
  {
    ...
    items: [
      ...
      "The Trend column shows each vessel's speed history as a sparkline; a larger chart appears in Behavioral Insights.",
      "Compare two vessels side by side with the Compare button in the Fleet Board — pick any two rows.",
